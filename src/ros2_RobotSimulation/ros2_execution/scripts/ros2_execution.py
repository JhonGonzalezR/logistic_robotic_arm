...
def main(args=None):
    ...
    filepath = os.path.join(os.path.expanduser('~'), 'logistic_robotic_arm', 'src', 'ros2_RobotSimulation', 'ros2_execution', 'programs', PR_NAME + ".txt")
    ...
    for i in range (1, len(seq)+1):
        ...
        if (trigger['action'] == 'MoveJ'):
            ...
            positiony = trigger['value']['positiony']
            positionz = trigger['value']['positionz']
            #print(f"pos en x {positionx}, en y {positiony} en z {positionz} JHOON")
